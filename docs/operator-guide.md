...
2. Define consent and purpose categories for glassworker/workshop records.
...
- safety-critical escalation path (burn hazard, cut hazard, furnace
  condition)
- provenance for all operating records (glassworker and workshop both
  independently registered)
- human review for high-risk cases
- audit export for all gated actions
- a hard, unconditional block on any attempt to route a
  glass-forming/cutting-execution decision, or a
